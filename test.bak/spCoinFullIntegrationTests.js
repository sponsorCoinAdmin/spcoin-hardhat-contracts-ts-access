...
//    await logJSONTree();
  ...
  // VALIDATE NESTED SPONSOR RECORD
    let index = 0;
    let sponsorNestedRecord = await getSponsorRecordByKeys(index, PATREON_ACCOUNT_KEY, SPONSOR_ACCOUNT_KEY);
    ...
    let agentNestedRecord = await getAgentRecordByKeys(index, PATREON_ACCOUNT_KEY, SPONSOR_ACCOUNT_KEY, AGENT_ACCOUNT_KEY);
