...
- As of the release of this document node version 16 is required. If you need to migrate between node versions
-   please install nvm at <b>https://github.com/nvm-sh/nvm/blob/master/README.md</b>.
- This release required node 16 find your version with the command <b>node -version</b> if that is not the current node version, type <b>"nvm use 16"</b> to change to that version.
-   if required follow the nvm instructions to install the node version.
